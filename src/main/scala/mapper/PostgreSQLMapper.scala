...
package com.scleradb.plugin.dbms.rdbms.postgresql.mapper
...
class PostgreSQLMapper(loc: Location) extends SqlMapper {
    ...
    def tableString(table: Table): String = {
        ...
        val refStrs: List[String] = table.foreignKeys.filter { fk =>
